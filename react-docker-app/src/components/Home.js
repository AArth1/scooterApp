...
// //     <div className="home-container">
// //       <div className={`content ${showContent ? 'show' : ''}`}>
// //         <h1 className="title">ZipScoot</h1>
// //         <div className="scooter-animation">
// //           <div className="scooter">
...
//         </div>
//         <div className="buttons">
//           <Link to="/login" className="btn login-btn">START</Link>
//           <Link to="/register" className="btn register-btn">NEW GAME</Link>
//         </div>
//         <p className="tagline">PRESS START TO PLAY</p>
//       </div>
//     </div>
//   );
// };
...
//         <h1 className="logo">ZipScoot</h1>
//         <div className="nav-buttons">
//           <Link to="/login" className="btn login-btn">Log In</Link>
//           <Link to="/register" className="btn register-btn">Sign Up</Link>
//         </div>
//       </nav>
//       <main className="main-content">
//         <div className="hero-section">
//           <h2 className="hero-title">City Exploration Made Easy</h2>
//           <p className="hero-subtitle">Rent a scooter and zip through the city with style and ease.</p>
//           <Link to="/register" className="btn cta-btn">Get Started</Link>
//         </div>
//         <div className="scooter-animation">
